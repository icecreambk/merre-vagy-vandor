  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <a href="https://merre-vagy-vandor.vercel.app" className="cta-btn" target="_blank" rel="noopener">
          🗺️ Megnyitom a térképet
        </a>
        <span className="cta-sub">Ingyenes · Névtelen · 30 nap után törlődik</span>
      ...
      <section id="about">
        ...
        <div className="cards">
          <div className="card">
            ...
            <div className="card-text">A neved sosem jelenik meg a térképen. A koordinátákat 11 km-es pontossággal tároljuk. 30 nap után minden törlődik.</div>
          </div>
          <div className="card">
            <div className="card-icon">🌍</div>
      ...
      <section id="contact">
        ...
        <div className="contact-box">
          ...
          <a href="https://merre-vagy-vandor.vercel.app" target="_blank" rel="noopener" className="btn-outline">
            🗺️ Térkép alkalmazás
          </a>
        </div>
      </section>
